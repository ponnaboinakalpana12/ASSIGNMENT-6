...
\begin{lstlisting}
https://github.com/ponnaboinakalpana12/Assignment6/Assignment6.py
\end{lstlisting}
%
and latex-tikz codes from 
%
\begin{lstlisting}
https://github.com/ponnaboinakalpana12/Assignment6//Assignment6.tex
\end{lstlisting}
%
\section{Question No 2.16(Quad forms)}
Factorise  $6x^2+17x+5$.
%
\section{SOLUTION}  
\begin{enumerate}
\item
...
\end{align}
Hence (3x+1) and (2x+5)  are the factors.\\
Plot  the graph:
